...
import { Loader2, Map, Network, Plus, StickyNote } from "lucide-react";
...
const TYPES = [
  ...
  },
  {
    ...
    hint: "Bloc-notes",
    Icon: StickyNote,
    active: "border-amber-500 bg-amber-50 text-amber-800 dark:bg-amber-950/40 dark:text-amber-300",
  },
] as const;
